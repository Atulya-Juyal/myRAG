...
class TestPIIDetector:
    ...
    def test_detects_phone(self):
        found = self.detector.detect("Call me at 8934872947")
        assert "phone" in found

    def test_detects_aadhaar(self):
        found = self.detector.detect("Aadhaar: 1234-5678-9012")
    ...
    def test_masks_all_pii(self):
        text = "Email: a@b.com, Phone: 8934872947, Aadhaar: 123456789012"
        masked = self.detector.mask(text)
        assert "a@b.com" not in masked
        assert "8934872947" not in masked
